...
namespace SaveCard
{
    public partial class Form1 : Form
    {
        ...
        // Creats the Designated files for the xml Doc
        private void Form1_Load(object sender, EventArgs e)
        {
            if (!Directory.Exists(@"CardDeck/"))
            {
                Directory.CreateDirectory(@"CardDeck/");

                if (!Directory.Exists(@"CardDeck/MysteryDeck/"))
                    Directory.CreateDirectory(@"CardDeck/MysteryDeck/");

                if (!Directory.Exists(@"CardDeck/TreasureDeck/"))
                    Directory.CreateDirectory(@"CardDeck/TreasureDeck/");
            }
